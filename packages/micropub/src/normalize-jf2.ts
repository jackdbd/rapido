...
import type { JF2, JF2_Application_JSON } from './schemas/jf2.js'
 ...
 */
export const normalizeJf2 = (input: JF2): JF2_Application_JSON => {
  ...
  return output satisfies JF2_Application_JSON
}
